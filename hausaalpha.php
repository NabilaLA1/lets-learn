...
<head>
    ...
    <link rel="stylesheet" href="assets/css/hausaalpha.css">
            ...
            <?php foreach ($alphabets as $index => $alphabet): ?>
                <div class="mySlides fade">
                    <div class="content">
                        <!-- Alphabet -->
                        <div class="alphabet">
                            <img src="<?= $alphabet['hau_letter_img'] ?>" alt="Alphabet Image">
                            <button  class="alpha" onclick="playSound('letter<?= $index ?>')">
                            <i class="fa-solid fa-volume-high"></i>
                            </button>
                            <audio id="letter<?= $index ?>"src="<?= $alphabet['hau_letter_audio'] ?>">></audio>
                        </div>
                        <hr>
                        <!-- Object -->
                        <div class="object">
                            <img src="<?= $alphabet['hau_object_img'] ?>" alt="object_name">
                            <p><?= $alphabet['hau_object_name'] ?></p><button class="obj" onclick="playSound('object<?= $index ?>')">
                            <i class="fa-solid fa-volume-high"></i>
                            </button>
                            <audio id="object<?= $index ?>" src="<?= $alphabet['hau_object_audio']?>"></audio>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
